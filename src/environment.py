...
class Environment:
    ...
    def __save_methods(self):
        ...
        self.__join_tokens()
        save_dataframe(self.train_methods, constants.TRAIN_METHODS_FILE)
        save_dataframe(self.valid_methods, constants.VALID_METHODS_FILE)
        save_dataframe(self.test_methods, constants.TEST_METHODS_FILE)
        self.__split_tokens()
